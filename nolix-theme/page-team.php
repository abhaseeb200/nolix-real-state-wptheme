<?php
/**
 * Template Name: Team Page (About us)
 */
  ...
  <div class="container px-4">
    <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
      ...
      <div class="w-full lg:w-1/2 relative" data-aos="fade-left">
        ...
        <div
          class="absolute md:-bottom-12 -bottom-3 md:left-3 left-8 bg-navy text-white p-4 rounded-xl shadow-xl z-20 max-w-[420px]" data-aos="fade-up" data-aos-delay="300">
