    ...
    <div class="container px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4">
            <div class="bg-white rounded-2xl p-5 shadow-[0_0_20px_rgba(0,0,0,0.03)] hover:shadow-[0_0_30px_rgba(193,154,92,0.1)] transition-all duration-300"
                ...
                <div class="flex items-center gap-4 mb-8">
                    <div class="w-14 h-14 rounded-xl bg-[#EFE7D9] flex items-center justify-center flex-shrink-0">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/notification-text2.webp"
                            alt="Tenant Management Icon" class="w-8 h-8" />
                    </div>
                    ...
                    <li class="flex items-start gap-3">
                        <div class="bg-theme rounded-full flex justify-center w-6 h-6">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/check-circle.webp"
                                alt="Check Icon" class="w-4 h-4 mt-1 flex-shrink-0" />
                        </div>
                        <span class="text-[#767C8C] md:text-lg text-base font-light"> Sourcing and screening
                            tenants</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="bg-theme rounded-full flex justify-center w-6 h-6">
                        ...
                        <span class="text-[#767C8C] md:text-lg text-base font-light"> Contract drafting and
                            renewals</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="bg-theme rounded-full flex justify-center w-6 h-6">
                        ...
                        <span class="text-[#767C8C] md:text-lg text-base font-light"> Rent collection and timely
                            follow-ups</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="bg-theme rounded-full flex justify-center w-6 h-6">
                        ...
                        <span class="text-[#767C8C] md:text-lg text-base font-light"> Handling notices and legal
                            compliance</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-white rounded-2xl p-5 shadow-[0_0_20px_rgba(0,0,0,0.03)] hover:shadow-[0_0_30px_rgba(193,154,92,0.1)] transition-all duration-300"
                ...
                <div class="flex items-center gap-4 mb-8">
                    <div class="w-14 h-14 rounded-xl bg-[#EFE7D9] flex items-center justify-center flex-shrink-0">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/users.png"
                            alt="Property Care Icon" class="w-7 h-7" />
                    </div>
                    <h3 class="font-poppins font-semibold text-xl text-dark">
                        Property Care
                    </h3>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-[#767C8C] md:text-lg text-base font-light">Repair coordination with approved
                            vendors</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="bg-theme rounded-full flex justify-center w-6 h-6">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-[#767C8C] md:text-lg text-base font-light">Move-in and move out
                            management</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-white rounded-2xl p-5 shadow-[0_0_20px_rgba(0,0,0,0.03)] hover:shadow-[0_0_30px_rgba(193,154,92,0.1)] transition-all duration-300"
                ...
                <div class="flex items-center gap-4 mb-8">
                    <div class="w-14 h-14 rounded-xl bg-[#EFE7D9] flex items-center justify-center flex-shrink-0">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/credit-card.webp"
                            alt="Financial Reporting Icon" class="w-8 h-8" />
                    </div>
                    <h3 class="font-poppins font-semibold text-xl text-dark">
                        Financial Reporting
                    </h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] text-center flex flex-col items-center justify-center p-8 rounded-lg border border-white/10 hover:border-theme/50 transition duration-300"
                ...
                <div class="w-16 h-16 bg-[#314A6E] rounded-full flex items-center justify-center mb-6 text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/message-chat-circle.webp"
                        class="w-8 h-8" alt="Communication Icon" />
                </div>
            ...
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] text-center flex flex-col items-center justify-center p-8 rounded-lg border border-white/10 hover:border-theme/50 transition duration-300"
                ...
                <div class="w-16 h-16 bg-[#314A6E] rounded-full flex items-center justify-center mb-6 text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/notification-text.webp"
                        class="w-8 h-8" alt="Reporting Icon" />
                </div>
                <h3 class="font-poppins md:text-xl font-semibold tracking-wider mb-3">
                    Clear <br /> reporting
                </h3>
            ...
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] text-center flex flex-col items-center justify-center p-8 rounded-lg border border-white/10 hover:border-theme/50 transition duration-300"
                data-aos="fade-up" data-aos-delay="300">
                <div class="w-16 h-16 bg-[#314A6E] rounded-full flex items-center justify-center mb-6 text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shield-02.webp" class="w-8 h-8"
                        alt="Standards Icon" />
                </div>
                <h3 class="font-poppins md:text-xl font-semibold tracking-wider mb-3">
            ...
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] text-center flex flex-col items-center justify-center p-8 rounded-lg border border-white/10 hover:border-theme/50 transition duration-300"
                ...
                <div class="w-16 h-16 bg-[#314A6E] rounded-full flex items-center justify-center mb-6 text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clock.webp" class="w-8 h-8"
                        alt="Efficiency Icon" />
                </div>
                <h3 class="font-poppins md:text-xl font-semibold tracking-wider mb-3">
            ...
            <div class="w-full lg:w-1/2 relative" data-aos="fade-up">
                <div class="relative md:ml-0 ml-5">
                    <div
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/our-philosophy.webp"
                            alt="Our Philosophy Asset Management"
