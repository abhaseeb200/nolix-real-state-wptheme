...
<section class="py-20 lg:py-28 pb-0 bg-white" data-aos="fade-up">
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:px-10">
            <div class="p-10 bg-white shadow-[0_0_24px_0_#00000014] rounded-2xl transition-all duration-300 hover:-translate-y-1"
                data-aos="fade-up" data-aos-delay="100">
                <div class="w-16 h-16 bg-[#EFE7D9] rounded-xl flex items-center justify-center mb-6">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/heart.webp"
                        alt="Depth Over Volume" class="w-8 h-8 opacity-80" />
                </div>
            ...
            <div class="p-10 bg-white shadow-[0_0_24px_0_#00000014] rounded-2xl transition-all duration-300 hover:-translate-y-1"
                ...
                <div class="w-16 h-16 bg-[#EFE7D9] rounded-xl flex items-center justify-center mb-6">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shield.webp"
                        alt="Hand-Selected Portfolio" class="w-8 h-8 opacity-80" />
                </div>
                <h3 class="font-poppins text-xl font-bold mb-4 text-dark">
            ...
            <div class="p-10 bg-white shadow-[0_0_24px_0_#00000014] rounded-2xl transition-all duration-300 hover:-translate-y-1"
                ...
                <div class="w-16 h-16 bg-[#EFE7D9] rounded-xl flex items-center justify-center mb-6">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/users.png"
                        alt="Tailored Guidance" class="w-8 h-8 opacity-80" />
                </div>
                <h3 class="font-poppins text-xl font-bold mb-4 text-dark">
                    Tailored Guidance
                </h3>
            ...
            <div class="p-10 bg-white shadow-[0_0_24px_0_#00000014] rounded-2xl transition-all duration-300 hover:-translate-y-1"
                ...
                <div class="w-16 h-16 bg-[#EFE7D9] rounded-xl flex items-center justify-center mb-6">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/award.webp"
                        alt="End-to-End Care" class="w-8 h-8 opacity-80" />
                </div>
                <h3 class="font-poppins text-xl font-bold mb-4 text-dark">
                    End-to-End Care
                </h3>
        ...
        <div class="flex flex-col md:flex-row justify-between md:items-center items-start mb-8 md:mb-16 gap-8"
            ...
            <div class="w-full">
                <h2 class="font-playfair text-h2-custom font-bold uppercase leading-tight text-dark">
                    Nolix
                    <span class="text-theme">Academy</span>
                </h2>
            </div>
            <div class="max-w-md">
