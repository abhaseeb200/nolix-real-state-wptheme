...
function nolix_lease_property_form_shortcode() {
    ob_start();
    ?>
    <div id="lease-property-form-container" class="bg-white p-6 md:p-10 rounded-2xl shadow-xl border border-gray-100 max-w-5xl mx-auto relative overflow-hidden" data-aos="fade-up">
        ...
        <form id="lease-property-form" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-6 pt-6 border-t border-gray-100">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <select name="property_location" required class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:bg-white focus:border-theme focus:ring-1 focus:ring-theme outline-none transition-all appearance-none">
