            ...
            <div class="flex flex-col md:flex-row justify-between gap-12 mb-16">
                ...
                <div class="sm:max-w-[24%] max-w-full">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="#" class="text-white hover:text-navy transition-colors"><svg class="w-5 h-5"
            ...
            <!-- Contact Info -->
                <div class="max-w-full">
                    ...
                    <ul class="space-y-3 text-base text-white font-poppins">
                        <li><a href="mailto:Hello@Sparkodic.Com"
                                class="hover:text-white transition-colors">Hello@Sparkodic.Com</a></li>
                        <li><a href="tel:+14842844032" class="hover:text-white transition-colors">+1 (484) 2844-032</a>
                        </li>
                    </ul>
                </div>
            </div>
