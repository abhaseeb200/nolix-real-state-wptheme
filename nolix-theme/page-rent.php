          ...
          ?>
            ...
            <div class="flex border border-[#C8CCD9] px-2 py-2 rounded-lg gap-4 self-start md:self-auto">
                <button id="btn-grid-view"
                    class="md:w-10 md:h-10 w-8 h-8 flex items-center justify-center bg-theme text-white rounded hover:bg-opacity-90 transition">
                ...
                <button id="btn-list-view"
                    class="md:w-10 md:h-10 w-8 h-8 flex items-center justify-center border border-gray-200 bg-white text-[#00291B] rounded hover:bg-gray-50 transition">
                    <svg class="md:w-5 md:h-5 w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            <aside class="w-full lg:w-1/4 border border-[#C8CCD9] bg-white p-6 rounded-lg shadow-sm h-fit">
                ...
                <form id="property-filters-form">
                    <div class="mb-6">
                        <button type="button"
                            class="flex justify-between items-center w-full font-semibold mb-4 text-sm uppercase tracking-wide">
                            PROPERTY TYPE
              ...
              foreach($types as $type): ?>
                            <label class="flex items-center space-x-3 cursor-pointer group">
                                <div class="relative flex items-center">
                                    <input type="checkbox" name="property_type[]" value="<?php echo esc_attr($type); ?>"
                                        class="filter-checkbox peer h-5 w-5 cursor-pointer appearance-none rounded border border-gray-300 transition-all checked:border-theme checked:bg-theme hover:border-theme" />
                                    <svg class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3.5 h-3.5 pointer-events-none opacity-0 peer-checked:opacity-100 text-white transition-opacity"
                                        ...
                                        <path d="M3 7L5.5 9.5L11.5 3.5" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <span class="text-sm text-gray-600 group-hover:text-theme transition">
                                    <?php echo $type; ?>
                                </span>
                            </label>
                            <?php endforeach; ?>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <select name="bedrooms" id="filter-bedrooms"
                                class="filter-select w-full appearance-none border border-gray-200 rounded px-4 py-2.5 text-sm bg-[#F5F6FA] text-gray-600 focus:outline-none focus:border-theme">
                            ...
                            <div
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-[#00291B]">
                    ...
                    <div class="mb-8">
                        <label class="block font-semibold mb-3 text-sm uppercase tracking-wide">Annual Rent Range
                            (AED)</label>
                        <div class="space-y-3">
                            <div class="relative">
                                <input type="text" name="rent_min" id="filter-rent-min" placeholder="Min: 30,000"
                                    class="filter-input w-full border border-gray-200 rounded px-4 py-2.5 text-sm bg-[#F5F6FA] focus:outline-none focus:border-theme" />
                                <div
                            ...
                            <div class="relative">
                                <input type="text" name="rent_max" id="filter-rent-max" placeholder="Max: 30,000"
                                    class="filter-input w-full border border-gray-200 rounded px-4 py-2.5 text-sm bg-[#F5F6FA] focus:outline-none focus:border-theme" />
                                <div
                                    class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-400">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex gap-3">
                        <button type="button" id="apply-filters"
                            class="flex-1 bg-theme text-white py-3.5 rounded-lg text-sm hover:bg-opacity-90 transition shadow-sm disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                            <span id="apply-text">Apply</span>
                            <svg id="apply-spinner" class="hidden animate-spin h-4 w-4 text-white"
                        ...
                        <button type="button" id="reset-filters"
                            class="flex-1 bg-gray-200 text-gray-700 py-3.5 rounded-lg text-sm hover:bg-gray-300 transition shadow-sm disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                            <span id="reset-text">Reset</span>
                            <svg id="reset-spinner" class="hidden animate-spin h-4 w-4 text-gray-700"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                    stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor"
            ...
            ?>
                ...
                <div class="text-center mt-12" id="load-more-container">
                    <button id="load-more-btn" data-page="2"
                        class="inline-flex items-center justify-center gap-2 bg-theme text-white px-8 py-3 rounded-full hover:bg-opacity-90 transition font-medium uppercase shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed">
                        <span id="load-more-text">Load More</span>
                        <svg id="load-more-spinner" class="hidden animate-spin h-5 w-5 text-white"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
<section class="py-20 bg-navy text-white" data-aos="fade-up">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 text-left">
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] p-5 rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="100">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/check-circle.webp"
                        class="w-7 h-7" alt="">
                </div>
                <h3 class="font-poppins tracking-wider lg:text-xl font-bold mb-3 text-white">Verified Listings</h3>
                <p class="text-[#FFFFFF99] text-sm leading-relaxed tracking-wide">Every property on our platform is
                    personally verified by our agents.</p>
            </div>
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] p-5 rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="200">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/notification-text.webp"
                        class="w-7 h-7" alt="">
                </div>
                <h3 class="font-poppins tracking-wider lg:text-xl font-bold mb-3 text-white">Transparent Pricing</h3>
                <p class="text-[#FFFFFF99] text-sm leading-relaxed tracking-wide">No hidden fees or surprise costs.</p>
            </div>
            <div class="bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] p-5 rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="300">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/star-02.png" class="w-7 h-7"
                        alt="">
                </div>
                <h3 class="font-poppins tracking-wider lg:text-xl font-bold mb-3 text-white">Dedicated Support</h3>
                <p class="text-[#FFFFFF99] text-sm leading-relaxed tracking-wide">From viewing to move-in and beyond.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-white" data-aos="fade-up">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <!-- Step 1 -->
            <div class="bg-white p-6 border border-[#C8CCD9] flex flex-col items-center text-center rounded-xl shadow-sm hover:shadow-md transition"
                data-aos="fade-up" data-aos-delay="100">
                <div
            ...
            <!-- Step 2 -->
            <div class="flex flex-col items-center text-center bg-white p-6 border border-[#C8CCD9] rounded-xl shadow-sm hover:shadow-md transition"
                data-aos="fade-up" data-aos-delay="200">
                <div
                    class="w-10 h-10 rounded-full bg-theme text-white text-sm font-bold flex items-center justify-center mb-4">
                    02
...
<section class="py-20 bg-navy text-white" data-aos="fade-up">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="block p-5 bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="100">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/notification-text.webp"
                        class="w-7 h-7" alt="">
                </div>
                <h3 class="font-poppins lg:text-xl font-semibold tracking-wider mb-3 text-white">Visa Processing Support
                </h3>
                <p class="text-[#FFFFFF99] md:text-lg text-sm leading-relaxed tracking-wider">Assistance with residence
                    visa appllications and renewals for you and your family.</p>
            </div>

            <div class="block p-5 bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="200">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/wifi.png" class="w-7 h-7"
                        alt="">
                </div>
                <h3 class="font-poppins lg:text-xl font-semibold tracking-wider mb-3 text-white">Utility Connection</h3>
                <p class="text-[#FFFFFF99] md:text-lg text-sm leading-relaxed tracking-wider">Help with DEWA, internet,
                    and other utility setup.</p>
            </div>

            <div class="block p-5 bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="300">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home-03.webp" class="w-7 h-7"
                        alt="">
                </div>
                <h3 class="font-poppins lg:text-xl font-semibold tracking-wider mb-3 text-white">Ejari Registration</h3>
                <p class="text-[#FFFFFF99] md:text-lg text-sm leading-relaxed tracking-wider">Complete tenancy contract
                    registration with Dubai Land Department.</p>
            </div>

            <div class="block p-5 bg-[linear-gradient(0.1deg,rgba(247,184,116,0.15)_0%,rgba(97,97,97,0.09)_100%)] rounded-lg border border-white/10 hover:border-theme/50 flex flex-col md:text-left md:items-start text-center items-center transition duration-300"
                data-aos="fade-up" data-aos-delay="400">
                <div class="w-12 h-12 mb-6 bg-theme rounded-full flex items-center justify-center text-white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/settings-02.webp"
                        class="w-7 h-7" alt="">
                </div>
                <h3 class="font-poppins lg:text-xl font-semibold tracking-wider mb-3 text-white">Maintenance Coordination
                </h3>
                <p class="text-[#FFFFFF99] md:text-lg text-sm leading-relaxed tracking-wider">24/7 support for
                    maintenance requests and emergency repairs.</p>
            </div>
        </div>
    </div>
</section>
