...
<section
    ...
    style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/Palm Jumeira.avif');">
    <!-- Overlay -->
    ...
    <div
        ...
        <div class="my-14 max-w-5xl">
            ...
            <div class="flex md:flex-row flex-col md:gap-0 gap-2 items-center justify-center mb-3">
                ...
                <span class="text-white text-sm md:text-lg font-poppins">Relied on by 6.1k satisfied clients</span>
            </div>

            <!-- H1 Heading -->
            <h1 class="text-h1-custom font-playfair text-white font-bold leading-tight mb-6 uppercase drop-shadow-lg">
                A Curated Approach to <br>
                <span class="text-theme">Luxury Property</span> in the UAE.
            </h1>

            <!-- Paragraph -->
            <p class="text-p-custom text-[#EBEDF0] font-poppins mb-10 max-w-4xl mx-auto leading-relaxed drop-shadow-md">
                WE PRESENT A SELECTIVE PORTFOLIO OF VILLAS, APARTMENTS AND OFF-PLAN RESIDENCES. OUR OFFERS ARE
...
<!-- Stats Section -->
<section class="lg:pt-24 pt-16 bg-[#F5F6FA]" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16 text-center items-center">
            ...
            <div class="flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="100">
                <span
                    class="md:text-[80px] text-[60px] font-bold text-counter leading-none font-helvetica tracking-tighter relative"><span
                        class="counter-number" data-target="2.5">0</span>k<sup
                        class="absolute sm:top-4 top-2.5 right-0 text-[24px] text-theme font-medium"></sup></span>
                <span class="bg-dark text-white text-[16px] font-poppins px-4 py-1.5 rounded-full shadow-lg">Properties
                    Sold</span>
            </div>
            ...
            <div class="flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="200">
                <span
                    class="md:text-[80px] text-[60px] font-bold text-counter leading-none font-helvetica tracking-tighter relative"><span
                        class="counter-number" data-target="6.1">0</span>k<sup
                        class="absolute sm:top-4 top-2.5 right-0 text-[24px] text-theme font-medium"></sup></span>
            ...
            <div class="flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="300">
                <span
                    class="md:text-[80px] text-[60px] font-bold text-counter leading-none font-helvetica tracking-tighter relative"><span
                        class="counter-number" data-target="9">0</span>k<sup
                        class="absolute sm:top-4 top-2.5 right-0 text-[24px] text-theme font-medium"></sup></span>
...
<!-- Why Nolix Section -->
<section class="lg:py-24 py-[72px] bg-[#F5F6FA]" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6">

        <!-- Heading -->
        <div class="text-center lg:mb-16 mb-10" data-aos="fade-up">
            ...
            <p class="md:text-lg font-poppins max-w-2xl mx-auto leading-relaxed text-[#00291B]">
        ...
        <div class="grid md:grid-cols-3 gap-12">
            <!-- Item 1 -->
            <div class="flex flex-col md:justify-center items-center text-center" data-aos="fade-up"
                data-aos-delay="100">
                <div
                ...
                <h3 class="text-h3-custom font-helvetica font-medium text-gray-900 mb-4 leading-tight">Curated
                    Inventory</h3>
                <p class="md:text-[18px]  text-[#767C8C] font-poppins leading-relaxed">
    ...
    <div class="container max-w-[1280px] mx-auto px-6">
        <div class="flex flex-col md:flex-row gap-9 items-center">
            ...
            <div class="sm:max-w-[45%] max-w-full relative h-[330px] md:h-[550px] w-full rounded-lg overflow-hidden"
                data-aos="fade-up">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/emaar.webp"
                    alt="Legacy Skyscraper"
                    class="w-full h-full object-cover object-top">
            </div>

            <!-- Text Side -->
            <div class="sm:max-w-[55%] max-w-full" data-aos="fade-up">
                <div class="border-l-4 border-theme pl-5 py-2">
                    <h2 class="md:text-[33px] text-[26px] font-playfair font-bold text-gray-900 uppercase leading-tight">
                        ...
                        Redefining Landscapes, Elevating Lives
                    </h2>
                </div>

                <div class="pl-5 mt-8">
                    <p class="md:text-[18px] text-[16px] text-[#767C8C] font-poppins leading-relaxed">
                        At NOLIX, we believe that each property possesses the potential to transcend
                        the ordinary and evolve into a true masterpiece. Every project we embark upon is an endeavor
                        and a profound opportunity to redefine landscapes and enhance lives.
                    </p>
                </div>
            </div> <!-- Text Side END -->
...
<section class="lg:py-24 py-16 bg-navy" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-12 md:gap-8 text-center md:text-left">
            <!-- Buy -->
            <div class="group" data-aos="fade-up" data-aos-delay="100">
                <div class="rounded-xl overflow-hidden mb-6 relative h-64">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/property-bg.webp" alt="Buy"
                ...
                <p class="text-white/70 font-poppins mb-6 min-h-[48px]">Guided property buying for homeowners and investors.</p>
                <a href="<?php echo site_url('/buy'); ?>"
            ...
            <div class="group" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="text-white/70 font-poppins mb-6 min-h-[48px]">Strategic marketing to sell your property faster and smarter.</p>
            ...
            <div class="group" data-aos="fade-up" data-aos-delay="300">
                <div class="rounded-xl overflow-hidden mb-6 relative h-64">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/key-inside-door.webp" alt="Rent"
                        class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                    <div class="absolute top-4 left-4 bg-white/90 p-3 rounded-full">
                        <svg class="w-6 h-6 text-theme" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <p class="text-white/70 font-poppins mb-6 min-h-[48px]">End-to-end rental support for landlords and tenants.</p>
...
<!-- Latest Properties -->
<section class="lg:py-24 py-16 bg-white" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6">
        ...
        <div class="flex flex-col items-center text-center mb-12" data-aos="fade-up">
            ...
            <a href="<?php echo site_url('/rent'); ?>"
               class="mt-6 bg-theme text-white px-8 py-3 rounded-full font-poppins font-medium hover:bg-opacity-90">
               View All Properties
            </a>
        </div>
        ...
        <a href="<?php echo site_url('/team'); ?>"
            class="text-center mt-8 mx-auto block md:hidden md:w-full w-[68%] bg-theme text-white px-8 py-3 rounded-full font-poppins font-medium hover:bg-opacity-90">View
            All Properties</a>
    </div>
</section>
...
<section class="lg:py-24 py-16 bg-[#FAFAFA] border-t border-gray-100 text-center" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6">

        <h2 class="text-h2-custom font-playfair font-bold text-gray-900 mb-2 uppercase" data-aos="fade-up">
            What our <span class="text-theme">clients Are Saying</span>
        </h2>
        <p class="text-[#00291B] md:text-lg font-poppins mb-12 max-w-2xl mx-auto" data-aos="fade-up"
            data-aos-delay="100">
                ...
                <div class="swiper-slide h-auto">
                    <div
                        ...
                        <div class="flex items-center gap-4 mt-auto">
                            ...
                            <div>
                                <div class="text-left font-bold text-[#1E2A39]">
                                    <?php the_title(); ?>
                                </div>
                                <div class="text-left text-sm text-[#767C8C] font-poppins">
...
<section class="lg:py-24 py-16 bg-white" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6 text-center">
        ...
        <div class="space-y-4 text-left">
            <!-- Item 1 -->
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                data-aos-delay="100">
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B]">Why should I invest in Dubai properties?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                ...
                <div class="faq-content h-0overflow-hidden transition-all duration-300 ease-in-out">
                    <div
                        class="pb-6 sm:pl-[1.2rem] sm:pr-[1.2rem] pl-16 pr-5  md:text-base text-p-custom md:px-20 text-[#767C8C] font-poppins leading-relaxed border-t border-gray-50">
                        Dubai offers tax-free returns, a growing economy, and high rental yields, making it a top choice for real estate investing. With options ranging from off plan 
						property to ready units, Dubai attracts both local and international investors.
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">Can foreigners buy property in Dubai?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                ...
                <div class="faq-content h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div
                        class="pb-6 sm:pl-[1.2rem] sm:pr-[1.2rem] pl-16 pr-5  md:text-base text-p-custom md:px-20 text-[#767C8C] font-poppins leading-relaxed border-t border-gray-50">
                        Yes, foreigners can legally buy property in Dubai in designated freehold areas such as Downtown Dubai, Dubai Marina and Palm Jumeirah. Whether 
						you’re looking for luxury Dubai property for sale or affordable apartments, we guide you through the entire purchase process.
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">How do I find the best property for sale in Dubai?
</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                ...
                <div class="faq-content h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div
                        class="pb-6 sm:pl-[1.2rem] sm:pr-[1.2rem] pl-16 pr-5  md:text-base text-p-custom md:px-20 text-[#767C8C] font-poppins leading-relaxed border-t border-gray-50">
                        Our expert team at Nolix Real Estate helps you navigate the market using advanced tools like 
						property finder Dubai platforms and our exclusive listings. We specialize in prime locations and provide 
						insights into Dubai investment properties for long-term value.
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                data-aos-delay="400">
                <button class="faq-btn w-full flex items-center justify-between p-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        <span
                            class="w-8 h-6 md:h-8 rounded-full bg-theme text-white flex items-center justify-center text-xs font-bold">04</span>
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">Do you offer property for rent in Dubai?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                ...
                <div class="faq-content h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div
                        class="pb-6 sm:pl-[1.2rem] sm:pr-[1.2rem] pl-16 pr-5  md:text-base text-p-custom md:px-20 text-[#767C8C] font-poppins leading-relaxed border-t border-gray-50">
                        Absolutely! We provide a wide selection of property for rent in Dubai, including studio apartments, villas, 
						and luxury property for rent Dubai-wide, especially in sought-after areas like Dubai Marina.
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">What types of commercial property for rent in Dubai are available?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                ...
                <div class="faq-content h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div
                        class="pb-6 sm:pl-[1.2rem] sm:pr-[1.2rem] pl-16 pr-5  md:text-base text-p-custom md:px-20 text-[#767C8C] font-poppins leading-relaxed border-t border-gray-50">
                        From office spaces in Business Bay to retail shops in Jumeirah, we offer various options for commercial property 
						for rent in Dubai. Our portfolio suits startups, SMEs and large enterprises.
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        <span
                            class="w-8 h-6 md:h-8 rounded-full bg-theme text-white flex items-center justify-center text-xs font-bold">06</span>
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">What is off-plan property, and is it a good investment?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                ...
                <div class="faq-content h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div
                        class="pb-6 sm:pl-[1.2rem] sm:pr-[1.2rem] pl-16 pr-5  md:text-base text-p-custom md:px-20 text-[#767C8C] font-poppins leading-relaxed border-t border-gray-50">
                        Off-plan property refers to real estate purchased before construction is complete. These properties often come at a 
						lower price and offer flexible payment plans, making them ideal for investors looking for high ROI in Dubai’s growing market.
