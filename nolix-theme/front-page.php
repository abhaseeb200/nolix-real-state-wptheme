    ...
    <div class="container max-w-[1280px] mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16 text-center items-center">
            ...
            <div class="flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="100">
                <span
                    class="md:text-[80px] text-[60px] font-bold text-counter leading-none font-helvetica tracking-tighter relative"><span
                        class="counter-number" data-target="8">0</span>k<sup
            ...
            <div class="flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="200">
                <span
                    class="md:text-[80px] text-[60px] font-bold text-counter leading-none font-helvetica tracking-tighter relative"><span
                        class="counter-number" data-target="14">0</span>k<sup
                        class="absolute sm:top-4 top-2.5 right-0 text-[24px] text-theme font-medium">+</sup></span>
            ...
            <div class="flex flex-col items-center justify-center gap-6" data-aos="fade-up" data-aos-delay="300">
                <span
                    class="md:text-[80px] text-[60px] font-bold text-counter leading-none font-helvetica tracking-tighter relative"><span
                        class="counter-number" data-target="16">0</span>k<sup
                        class="absolute sm:top-4 top-2.5 right-0 text-[24px] text-theme font-medium">+</sup></span>
        ...
        <div class="flex flex-col md:flex-row gap-9 items-center">
            ...
            <div class="sm:max-w-[55%] max-w-full" data-aos="fade-up">
                <div class="border-l-4 border-theme pl-5 py-2">
                    <h2
                        class="md:text-[33px] text-[26px] font-playfair font-bold text-gray-900 uppercase leading-tight">
        ...
        <div class="swiper myJourneySwiper max-w-5xl mx-auto mb-12">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <h2
                        class="md:text-[44px] text-[26px] max-w-[800px] font-playfair text-white text-center leading-tight mx-auto drop-shadow-2xl">
                        <span class="font-poppins">"</span>Excellence is not a destination but a continuous journey of
                        refined service. <span class="font-poppins">"</span>
                    </h2>
                </div>
                <div class="swiper-slide">
                    <h2
                        class="md:text-[44px] text-[26px] max-w-[1000px] font-playfair text-white text-center leading-tight mx-auto drop-shadow-2xl">
                        <span class="font-poppins">"</span>True luxury is about the details that others
                        overlook—creating moments of perfection. <span class="font-poppins">"</span>
                    </h2>
                </div>
                <div class="swiper-slide">
                    <h2
                        class="md:text-[44px] text-[26px] max-w-[1000px] font-playfair text-white text-center leading-tight mx-auto drop-shadow-2xl">
                        <span class="font-poppins">"</span>Our commitment extends beyond the transaction, building
                        lasting legacies for generations. <span class="font-poppins">"</span>
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center gap-4 max-w-2xl mx-auto mt-6">
            ...
            <div class="h-1 bg-white/20 rounded-full flex-1 overflow-hidden">
                <div id="journey-progress"
                    class="h-full bg-theme w-1/3 rounded-full relative overflow-hidden transition-all duration-300">
...
<section class="lg:py-24 py-16 bg-navy" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6 text-center">
        ...
        <div class="mb-12" data-aos="fade-up">
            ...
            <p class="text-white/80 font-poppins md:text-lg">Comprehensive real estate solutions tailored to
                your
                unique needs</p>
        </div>
...
<section class="lg:py-24 py-16 bg-white" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto px-6">
        <div class="flex justify-center items-end mb-12" data-aos="fade-up">
            <div>
...
<!-- Academy Section -->
<section class="lg:py-24 py-16 bg-[#F5F6FA]" data-aos="fade-up">
    <div class="container max-w-[1280px] mx-auto lg:pr-[1.5rem] lg:pl-[2.5rem] px-6">
        <div class="grid md:grid-cols-2 gap-10 items-center">
            <!-- Content -->
            <div data-aos="fade-up">
                <h2 class="text-h2-custom font-playfair font-bold text-gray-900 mb-4 uppercase">NOLIX <span class="text-theme"> Academy </span></h2>
                <p class="text-[#00291B] font-poppins mb-6">Clarity for first-time and seasoned
                    owners</p>
                <p class="text-[#767C8C] md:text-base font-poppins leading-relaxed mb-8">
                ...
                <ul class="space-y-4 mb-10">
                    <li class="flex items-center gap-4">
                        ...
                        <span class="text-[#767C8C] md:text-base font-poppins">Comprehensive market guides
                            and reports</span>
                    </li>
                    <li class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full bg-theme/10 flex items-center justify-center text-theme">
                        ...
                        <span class="text-[#767C8C] md:text-base font-poppins">Legal and financing
                            documentation explained</span>
                    </li>
                    <li class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full bg-theme/10 flex items-center justify-center text-theme">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-[#767C8C] md:text-base font-poppins">One-on-one consultation
                            sessions</span>
                    </li>
                </ul>
            ...
            <div class="relative" data-aos="fade-up">
                <div
                    class="rounded-2xl sm:p-4 p-0 z-10 relative before:content-[''] before:bg-transparent before:w-[90%] before:h-[85%] md:before:h-[92%] before:flex before:absolute before:border-2 before:border-theme before:rounded-[16px] before:top-[48px] md:before:left-[-6px] before:left-[-10px] before:z-[-1] ">
                    <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
                        alt="Academy"
                        class="h-[250px] md:h-[350px] md:h-full rounded-xl shadow-2xl w-full object-cover">
                </div>
                <!-- Floating Badge -->
                <div
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B]">What is the
                            process of Buying a
                            Home?</span>
                    </div>
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">How much
                            should I offer when I
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">What is
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between p-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">Can I tour
                            a property before
                            purchasing?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
            ...
            <div class="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all" data-aos="fade-up"
                ...
                <button class="faq-btn w-full flex items-center justify-between px-6 py-6 bg-white">
                    <div class="flex items-center md:px-2 gap-4">
                        ...
                        <span class="md:text-lg text-left text-base font-bold font-helvetica text-[#00291B] ">How I know
                            which property I
                            should buy?</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" fill="none" stroke="currentColor"
